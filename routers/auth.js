...
const domain = 'https://oxynet.live'
...
authRouter.patch('/v1/users/change-pw', async (req, res) => {
	console.log(req)
...
authRouter.post('/v1/users/login', async (req, res) => {
...
authRouter.post('/v1/users/fpw/get', async (req, res) =>{
...
authRouter.get('/v1/users/fpw/auth',async(req,res)=>{
...
authRouter.post('/v1/users/signup/auth', async(req, res) => {
...
authRouter.get('/v1/users/signup/verify', async(req,res)=> {
